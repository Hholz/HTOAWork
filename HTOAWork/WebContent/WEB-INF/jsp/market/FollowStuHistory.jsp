...
<title>意向学生跟踪</title>
	...
	<script type="text/javascript">
		...
		var TableInit = function(){
			...
			table.Init = function(){
				$('#tb_intentionStudent').bootstrapTable({
					url : '${pageContext.request.contextPath}/market/follow/followStudentListJsonHistory', //请求后台的URL（*）
					method : 'post', //请求方式（*）
		...
		function look(){
			window.location.href='${pageContext.request.contextPath}/market/follow/page'; 
		}
	</script>
</head>
<body>
	                ...
	                <div class="ibox float-e-margins">
	                    ...
	                    <div class="ibox-content">
	                        <div id="toolbar" class="btn-group">
								<button id="btn_money" type="button" class="btn btn-warning btn-outline" onclick="look()">
									<i class="fa fa-mail-reply-all"></i>返回上一页面
								</button>
							</div>
							<!-- table代码就这些，用js构建表格 -->
