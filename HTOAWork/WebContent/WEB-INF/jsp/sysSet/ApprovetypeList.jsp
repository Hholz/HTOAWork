...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#btn_edit").click(function() {
			...
			$("#window_update #flowmodelname").val(rows.approvename);
	...
	var TableInit = function() {
		...
		oTableInit.Init = function() {
			$('#tb_departments')
					.bootstrapTable(
							{
								url : '${pageContext.request.contextPath}/sysSet/Approvetype/0', //请求后台的URL（*）
								method : 'post', //请求方式（*）
	...
	function addStudent() {
		...
		var url = "${pageContext.request.contextPath }/sysSet/Approvetype/add";
		$.post(url, {
			approvename : $("#window_update #flowmodelname").val(),
	...
	function updateStudent() {
		...
		var url = "${pageContext.request.contextPath }/sysSet/Approvetype/"
				+ id;
		$.post(url, {
			_method : 'PUT',//改成PUT提交
			id : $("#window_update #id").val(),
			approvename : $("#window_update #flowmodelname").val(),
			invalid : $("input[type='radio']:checked").val(),
	...
	function deleteStudent() {
		...
		var id = rows.id;
		alert(id);
		var url = "${pageContext.request.contextPath }/sysSet/Approvetype/" + id;
		$.post(url, {
											...
											<div class="form-group">
												<div class="col-sm-9">
													<label class="radio-inline"> <input type="radio"
														checked="checked" value="1" id="optionsRadios1"
														name="invalid">有效
													</label> <label class="radio-inline"> <input type="radio"
														value="0" id="optionsRadios2" name="invalid">无效
													</label>
												</div>
											</div>
										</div>
