...
<script type="text/javascript">
	function yes(id) {
		var url = "${pageContext.request.contextPath }/student/NewComputer/over"
		$.post(url, {
			id : id,
			stat : 6,
	...
	function updateStudentHandle() {
		...
		location.href = "${pageContext.request.contextPath }/student/NewComputer/tasklist";
	}
</script>
</head>
<body class="gray-bg">
					...
					<div class="ibox-content">
						...
						<ul class="sortable-list connectList agile-list">
							<c:forEach items="${overtasklist }" var="data">
								<li class="warning-element">已给 ${data.student.stuname}发放.
									<div class="agile-detail">
