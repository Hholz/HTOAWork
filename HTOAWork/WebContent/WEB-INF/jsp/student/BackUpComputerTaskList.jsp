...
<script type="text/javascript">
	function yes(id) {
		var url = "${pageContext.request.contextPath }/student/BackUpComputer/over"
		$.post(url, {
			id : id,
			stat : 3,
	...
	function updateStudentHandle(data) {
		...
		if(data<0){
			parent.layer.alert('备用电脑不够了！');
			return;
		}
		location.href = "${pageContext.request.contextPath }/student/BackUpComputer/tasklist";
	}
</script>
</head>
<body class="gray-bg">
						...
						<ul class="sortable-list connectList agile-list">
							<c:forEach items="${materiallist }" var="data">
								<li class="warning-element">
									${data.student.stuname}申请备用电脑,原因是：${data.remark}.
