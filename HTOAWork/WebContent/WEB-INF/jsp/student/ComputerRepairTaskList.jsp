...
<script type="text/javascript">
	function yes(id) {
		var url = "${pageContext.request.contextPath }/student/ComputerRepair/over"
		$.post(url, {
			id : id,
			stat : 2,
	...
	function updateStudentHandle() {
		...
		location.href = "${pageContext.request.contextPath }/student/ComputerRepair/tasklist";
	}
</script>
</head>
<body class="gray-bg">
						...
						<ul class="sortable-list connectList agile-list">
							<c:forEach items="${materiallist }" var="data">
								<li class="warning-element">
									${data.student.stuname}的电脑申请维修,原因是：${data.remark}.
