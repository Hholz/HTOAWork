...
<div class="middle-box text-center loginscreen   animated fadeInDown">
    <div>
        ...
        <form class="m-t" role="form" action="${pageContext.request.contextPath }/toRegister" method="post">
            ...
            <div class="form-group">
                <input type="text" id="" name="" class="form-control" placeholder="请输入短信验证码" required="">
            </div>
            <div class="form-group">
