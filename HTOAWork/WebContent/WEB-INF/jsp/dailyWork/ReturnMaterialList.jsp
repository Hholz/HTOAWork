...
<script type="text/javascript">
	...
	var TableInit = function() {
		...
		oTableInit.Init = function() {
			$('#tb_departments')
					.bootstrapTable(
							{
								url : '${pageContext.request.contextPath}/dailyWork/ReturnMaterial/0', //请求后台的URL（*）
								method : 'post', //请求方式（*）
	...
	function addStudent() {
		...
		var url = "${pageContext.request.contextPath }/dailyWork/ReturnMaterial/add";
		$.post(url, {
	...
	function updateStudent() {
		...
		var url = "${pageContext.request.contextPath }/dailyWork/ReturnMaterial/"
				+ id;
		$.post(url, {
			_method : 'PUT',//改成PUT提交
	...
	function upset() {
		...
		var id = rows.id;
		var url = "${pageContext.request.contextPath }/dailyWork/ReturnMaterial/upset";
	...
	function selectemp() {
		var url = "${pageContext.request.contextPath }/dailyWork/ReturnMaterial/findMaterial";
		$.post(url, {
	...
	<div class="panel-body" style="padding-bottom: 0px;">
		...
		<div id="toolbar" class="btn-group">
			<button id="btn_add" type="button" class="btn btn-w-m btn-primary"
				data-toggle="modal">
				<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>归还
			</button>
