    ...
    <script>
	    ...
	    function btnadd(){
			...
			$.post(
				...
				function(data){
					if(data>=1){
						toastr.success('新增统计数据', '新增成功');
					}else{
						toastr.error('新增统计数据', '新增失败');
					}
				},
				"text"
			);	
	    ...
	    $(function () {
			$('#tb_student').bootstrapTable({
				url : '${pageContext.request.contextPath}/dailyWork/holidayList', //请求后台的URL（*）sreward/stureward、stuheart/sayheart
				method : 'post', //请求方式（*）
				...
				columns : [ {
					...
					title : '所在部门',
						formatter : function(value, row,
							...
							if (emp == null) {
								return "-";
							} else if(emp.dep == null){
								return "-";
							}else{
								return emp.dep.depname;
							}
						}
				}, {
					field : 'strattime',
	            ...
	            columns : [{
					...
					formatter : function(value, row, index) {
						...
						if(stat == 0){
							...
							return "<span class='btn btn-info btn-xs dropdown-toggle'>节假日</span>";
						}else if(stat == 8){
...
<body>
     ...
     <div class="panel-body" style="padding-bottom: 0px;">
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5><span class="glyphicon glyphicon-question-sign"></span> ${ename}的月度考勤统计 </h5>
							...
							<div class="form-group">
								...
								<div class="col-sm-2">
									<select class="chosen-select" style="width:120px;height:33px;" tabindex="2" name="holidaystat" id="holidaystat">
		                              	...
		                              	<option value="7">节假日</option >
		                              	<option value="8">忘打卡一次</option>
		                              	<option value="9">忘打卡两次</option>
		                            </select>
								</div>
								<div class="col-sm-3">
								...
								<input type="hidden" value="${stat.finger}" name="empid" id="empid"/>
								<input type="hidden" value="${eid}" name="qjempid" id="qjempid"/>
        ...
        <div id="toolbar" class="btn-group">
			<!-- <button id="btn_add" type="button" class="btn btn-w-m btn-primary"
				 onclick="btnadd()" >onclick="addStart()"
				<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>生成考勤统计
			</button> -->
			<button id="btn_mb" type="button" class="btn btn-w-m btn-success" onclick="window.location.href='${pageContext.request.contextPath}/dailyWork/attenTojijsp'">
				<i class="fa fa-mail-reply"></i> 返回
			</button>
			<button id="btn_find" data-toggle="modal" data-target="#window_find" type="button"
	...
	<div class="modal inmodal" id="window_find" tabindex="-1" role="dialog"
		aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content animated bounceInRight">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="ts">
						<font color="#4876FF">请假人：${ename}</font>
					</h4>
				</div>
