...
<script type="text/javascript">
	...
	var TableInit = function() {
		...
		oTableInit.queryParams = function(params) {
			var temp = { //这里的键的名字和控制器的变量名必须一直，这边改动，控制器也需要改成一样的
				...
				collegename : $("#find_collegename").val(),
	...
	function addStudent() {
		...
		$('#tb_departments').bootstrapTable('refresh');
		//清空新增div中的数据
		$("#window_add #collegename").val('');
		$("#window_add #enddate").val('');
		$("#window_add #startdate").val('');
		$("#window_add #eduRemark").val('');
	}
					...
					<div class="ibox-content">
						<form id="formSearch" class="form-horizontal">
							<div class="form-group">
	                            ...
	                            <div class="col-sm-3">
	                                <input id="find_collegename" type="text" required class="form-control">
	                            </div>
                                <label class="col-sm-1 control-label">学历:</label>
                                <div class="col-sm-3">
                                	<select id="find_degree" class="form-control">
                                			<option value="">--------------</option>
                            ...
                            <div class="form-group">
                                <label class="col-sm-1 control-label">入校时间:</label>
                                <div class="col-sm-3">
									<input placeholder="入校时间" class="form-control layer-date"
										id="find_startdate">
								</div>
