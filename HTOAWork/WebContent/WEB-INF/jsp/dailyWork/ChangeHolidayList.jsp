	...
	var TableInit = function() {
		...
		oTableInit.Init = function() {
			$('#tb_departments').bootstrapTable({
				url : '${pageContext.request.contextPath}/dailyWork/Holiday/4', //请求后台的URL（*）
				method : 'post', //请求方式（*）
		...
		<div class="modal-dialog">
			<div class="modal-content animated bounceInRight">
				<div class="modal-header">
					...
					<h4 class="modal-title">员工调休申请</h4>
				</div>
				<div class="ibox-content">
					<form class="form-horizontal m-t" id="commentForm"
						...
						<div class="form-group">
							<label class="col-sm-3 control-label">*原本日期：</label>
							<div class="col-sm-8">
								<input placeholder="开始时间" class="form-control layer-date"
									required id="startdate_add" name="startdate">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input placeholder="结束时间" class="form-control layer-date"
									required id="enddate_add" name="enddate">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label">*调休原因：</label>
							<div class="col-sm-8">
