...
<script type="text/javascript">
	function yes(id) {
		var url = "${pageContext.request.contextPath }/dailyWork/OverWorkTask/over"
		$.post(url, {
			id : id,
			approvalstatus : 3,
	...
	function updateStudentHandle() {
		...
		location.href = "${pageContext.request.contextPath }/dailyWork/OverWorkTask/tasklist";
	}
</script>
</head>
<body class="gray-bg">
						...
						<ul class="sortable-list connectList agile-list">
							<c:forEach items="${materiallist }" var="data">
								<li class="warning-element">
									${data.empname }申请了加班${data.holidayday}个小时,理由是:${data.holidayRemark}.
