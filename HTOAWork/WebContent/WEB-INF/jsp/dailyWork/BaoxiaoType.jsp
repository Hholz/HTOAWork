    ...
    //全局变量，用来保存选中行的数据
	    ...
	    $(function () {
			...
			$("#btn_edit").click(function(){
	            ...
	            $("#window_update #baoxiaotypename").val(rows.baoxiaotypename);
	            $("#window_update #baoxiaotypeRemark").val(rows.baoxiaotypeRemark);
	    ...
	    var TableInit = function() {
			...
			oTableInit.Init = function() {
				$('#tb_departments').bootstrapTable({
					url : '${pageContext.request.contextPath}/dailyWork/Baoxiaotype/0', //请求后台的URL（*）
					method : 'post', //请求方式（*）
			...
			oTableInit.queryParams = function(params) {
				var temp = { //这里的键的名字和控制器的变量名必须一直，这边改动，控制器也需要改成一样的
					...
					baoxiaotypename : $("#find_baoxiaotypename").val(),
					baoxiaotypeRemark : $("#find_baoxiaotypeRemark").val()
				};
				return temp;
			};
			return oTableInit;
		...
		function addStudent(){
			...
			var url = "${pageContext.request.contextPath }/dailyWork/Baoxiaotype/add";
			$.post(
				url,
				{	
					_method:'PUT',
					baoxiaotypename:$("#window_add #baoxiaotypename").val(),
					baoxiaotypeRemark:$("#window_add #baoxiaotypeRemark").val()
				},
				addStudentHandle,
				"text"
			);	
			...
			$('#tb_departments').bootstrapTable('refresh');
			//清空新增div中的数据
            $("#window_add #baoxiaotypename").val('');
            $("#window_add #edu_remark").val('');
		}
		...
		function updateStudent(){
			...
			var url = "${pageContext.request.contextPath }/dailyWork/Baoxiaotype/"+id;
			$.post(
				url,
				{
					_method:'PUT',//改成PUT提交
					baoxiaotypename:$("#window_update #baoxiaotypename").val(),
					baoxiaotypeRemark:$("#window_update #baoxiaotypeRemark").val(),
				},
				updateStudentHandle,
				"text"
			);	
					...
					<div class="ibox-content">
						<form id="formSearch" class="form-horizontal">
							<div class="form-group">
                           		<label class="col-sm-2 control-label">报销类型名称：</label>
	                            <div class="col-sm-3">
	                                <input id="find_baoxiaotypename" type="text" required class="form-control">
	                            </div>
                                <label class="col-sm-2 control-label">说明：</label>
                                <div class="col-sm-3">
                                    <input id="find_baoxiaotypeRemark" type="text" required class="form-control">
                                </div>
								<div class="col-sm-1">
				...
				<div class="modal-content animated bounceInRight">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="updateForm" novalidate="novalidate" >
                            ...
                            <div class="form-group">
                           		<label class="col-sm-3 control-label">*报销类型名称：</label>
	                            <div class="col-sm-8">
	                               <input id="baoxiaotypename" name="baoxiaotypename" type="text" required class="form-control">
	                            </div>
                        	</div>
                            <div class="form-group">
                            	<label class="col-sm-3 control-label">*说明：</label>
	                            <div class="col-sm-8">
                                    <input type="text" name="baoxiaotypeRemark" class="form-control" id="baoxiaotypeRemark">
                                </div>
                        	</div>
