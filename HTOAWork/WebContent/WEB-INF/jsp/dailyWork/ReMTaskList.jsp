...
<script type="text/javascript">
	function yes(id) {
		alert(id);
		var url = "${pageContext.request.contextPath }/dailyWork/ReceiveMaterialTask/over"
		$.post(url, {
			id : id,
			approvalstatus : 3,
	...
	function updateStudentHandle() {
		...
		location.href = "${pageContext.request.contextPath }/dailyWork/ReceiveMaterialTask/tasklist";
	}
</script>
</head>
<body class="gray-bg">
						...
						<ul class="sortable-list connectList agile-list">
							<c:forEach items="${materiallist }" var="data">
								<li class="warning-element">
									${data.materialtypename}的申领：${data.empname }申领了${data.counts}${data.unit }${data.materialname},
