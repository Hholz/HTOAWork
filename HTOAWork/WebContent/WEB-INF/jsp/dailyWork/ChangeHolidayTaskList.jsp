...
<script type="text/javascript">
	function yes(id) {
		var url = "${pageContext.request.contextPath }/dailyWork/ChangeHolidayTask/over"
		$.post(url, {
			id : id,
			approvalstatus : 3,
	...
	function updateStudentHandle() {
		...
		location.href = "${pageContext.request.contextPath }/dailyWork/ChangeHolidayTask/tasklist";
	}
</script>
</head>
<body class="gray-bg">
						...
						<ul class="sortable-list connectList agile-list">
							<c:forEach items="${materiallist }" var="data">
								<li class="warning-element">
									${data.empname }申请了调休,由${data.starttime}调休到${data.endtime},理由是:${data.holidayRemark}.
