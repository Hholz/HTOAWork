...
<script type="text/javascript">
	function yes(id) {
		var url = "${pageContext.request.contextPath }/dailyWork/ReturnMaterialTask/over"
		$.post(url, {
			id : id,
			approvalstatus : 4,
	...
	function updateStudentHandle() {
		...
		location.href = "${pageContext.request.contextPath }/dailyWork/ReturnMaterialTask/tasklist";
	}
</script>
</head>
<body class="gray-bg">
						...
						<ul class="sortable-list connectList agile-list">
							<c:forEach items="${materiallist }" var="data">
								<li class="warning-element">
									${data.materialtypename}的归还：${data.empname }归还了${data.counts}${data.unit }${data.materialname}.
