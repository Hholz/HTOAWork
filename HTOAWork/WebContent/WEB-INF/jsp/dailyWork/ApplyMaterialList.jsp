...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#btn_edit").click(function() {
			...
			$("#window_add #materialname").val(rows.materialname);
			$("#window_add #materialtypeid").val(rows.materialtypeid);
			$("#window_add #unit").val(rows.unit);
			$("#window_add #price").val(rows.price);
			$("#window_add #style").val(rows.style);
		...
		$("#btn_add").click(function() {
			$("#window_add #id").val('');
			$("#window_add #materialname").val('');
			$("#window_add #unit").val('');
			$("#window_add #price").val('');
			$("#window_add #style").val('');
	...
	var TableInit = function() {
		...
		oTableInit.Init = function() {
			$('#tb_departments')
					.bootstrapTable(
							{
								url : '${pageContext.request.contextPath}/dailyWork/ApplyMaterial/0', //请求后台的URL（*）
								method : 'post', //请求方式（*）
	...
	function addStudent() {
		...
		var url = "${pageContext.request.contextPath }/dailyWork/ApplyMaterial/add";
		$.post(url, {
			materialname : $("#window_add #materialname").val(),
			materialtypeid : $("#window_add #materialtypeid").val(),
			unit : $("#window_add #unit").val(),
			price : $("#window_add #price").val(),
			style : $("#window_add #style").val(),
	...
	function updateStudent() {
		...
		var url = "${pageContext.request.contextPath }/dailyWork/ApplyMaterial/"
				+ id;
		$.post(url, {
			_method : 'PUT',//改成PUT提交
	...
	<div class="panel-body" style="padding-bottom: 0px;">
		...
		<div id="toolbar" class="btn-group">
			<button id="btn_add" type="button" class="btn btn-w-m btn-primary"
				data-toggle="modal">
				<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>申购
			</button>
					...
					<div class="ibox-content">
						<form class="form-horizontal m-t" id="commentForm"
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input id="materialname" type="text" required
										class="form-control">
								</div>
							</div>
							<div class="form-group">
