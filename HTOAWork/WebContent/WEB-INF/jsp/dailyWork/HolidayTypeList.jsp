    ...
    //全局变量，用来保存选中行的数据
	    ...
	    $(function () {
			...
			$("#btn_edit").click(function(){
	            ...
	            $("#window_update #materialtypename").val(rows.holidaytypename);
	            $("#window_update #matertypeRemark").val(rows.holidaytypeRemark);
		...
		var TableInit = function() {
			...
			oTableInit.Init = function() {
				$('#tb_departments').bootstrapTable({
					url : '${pageContext.request.contextPath}/dailyWork/Holidaytype/0', //请求后台的URL（*）
					method : 'post', //请求方式（*）
			...
			oTableInit.queryParams = function(params) {
				var temp = { //这里的键的名字和控制器的变量名必须一直，这边改动，控制器也需要改成一样的
					...
					holidaytypeRemark : $("#txt_search_remark").val(),
					holidaytypename : $("#mname").val(),
		...
		//新增学生，ajax提交
		function addStudent(){
			var url = "${pageContext.request.contextPath }/dailyWork/Holidaytype/add";
			$.post(
				url,
				{
					holidaytypename:$("#window_add #materialtypename").val(),
					holidaytypeRemark:$("#window_add #matertypeRemark").val(),
				},
				addStudentHandle,
				"text"
			);	
			...
			$('#tb_departments').bootstrapTable('refresh');
			//清空新增div中的数据
            $("#window_add #materialtypename").val('');
            $("#window_add #matertypeRemark").val('');
		}
		...
		function updateStudent(){
			...
			var url = "${pageContext.request.contextPath }/dailyWork/Holidaytype/"+id;
			$.post(
				url,
				{
					_method:'PUT',//改成PUT提交
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="commentForm" novalidate="novalidate" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="materialtypename" type="text" required class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">描述：</label>
                                <div class="col-sm-8">
                                    <input id="matertypeRemark" type="text" required class="form-control">
                                </div>
                            </div>
