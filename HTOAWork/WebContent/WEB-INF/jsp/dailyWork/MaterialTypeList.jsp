    ...
    //全局变量，用来保存选中行的数据
	    ...
	    $(function () {
			...
			$("#btn_edit").click(function(){
	            ...
	            $("#window_update #materialtypename").val(rows.materialtypename);
	            $("#window_update #matertypeRemark").val(rows.matertypeRemark);
		...
		var TableInit = function() {
			...
			oTableInit.Init = function() {
				$('#tb_departments').bootstrapTable({
					url : '${pageContext.request.contextPath}/dailyWork/MateriaType/0', //请求后台的URL（*）
					method : 'post', //请求方式（*）
			...
			oTableInit.queryParams = function(params) {
				var temp = { //这里的键的名字和控制器的变量名必须一直，这边改动，控制器也需要改成一样的
					...
					matertypeRemark : $("#txt_search_remark").val(),
					materialtypename : $("#mname").val(),
		...
		function addStudent(){
			...
			var url = "${pageContext.request.contextPath }/dailyWork/MateriaType/add";
			$.post(
				url,
				{
					materialtypename:$("#window_update #materialtypename").val(),
					matertypeRemark:$("#window_update #matertypeRemark").val(),
				},
				addStudentHandle,
				"text"
			);	
            ...
            $("#window_update #matertypeRemark").val('');
		}
		...
		function updateStudent(){
			...
			var url = "${pageContext.request.contextPath }/dailyWork/MateriaType/"+id;
			$.post(
				url,
				{
					_method:'PUT',//改成PUT提交
...
<body>
	<div class="panel-body" style="padding-bottom: 0px;">
					...
					<div class="ibox-content">
						<form id="formSearch" class="form-horizontal">
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input class="form-control" type="text" id="txt_search_remark">
								</div>
								<div class="col-sm-1">
		...
		<div id="toolbar" class="btn-group">
			<button id="btn_add" type="button" class="btn btn-w-m btn-primary" data-toggle="modal">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="commentForm" novalidate="novalidate" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="materialtypename" name="materialtypename" type="text" required class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">描述：</label>
                                <div class="col-sm-8">
                                    <input id="matertypeRemark" name="matertypeRemark" type="text" class="form-control">
                                </div>
                            </div>
                            <div class="modal-footer">
                                 <button type="button" class="btn btn-white" data-dismiss="modal">关闭</button>
                                 <button type="button" onclick="" id="save" class="btn btn-primary">保存</button>
                            </div>
                        </form>
                    </div>
				</div>
	...
	<script type="text/javascript">
		...
		function validateForm(formdata){
	        ...
	        var validator = formdata.validate({
	            ...
	            messages: {
	            	materialtypename: icon + "请输入用品类别名称",
	            },
	        });
