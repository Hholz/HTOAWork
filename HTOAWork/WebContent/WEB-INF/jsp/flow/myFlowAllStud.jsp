...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#query").click(function() {
			$("#tb_myFlowAllYes").bootstrapTable('refresh');
		});
		//表格数据
		$('#tb_myFlowAllYes').bootstrapTable({
			url : '${pageContext.request.contextPath}/flow/flowAll/findMyFlowAllStud', //请求后台的URL（*）
			method : 'post', //请求方式（*）
			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						...
						<table id="tb_myFlowAllYes"></table>
					</div>
				</div>
			</div>
		</div>
