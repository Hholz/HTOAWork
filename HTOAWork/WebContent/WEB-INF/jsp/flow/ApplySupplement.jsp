...
<script type="text/javascript">
	...
	function saveHoliday() {
		...
		if (stratTime == null || stratTime == "") {
			parent.layer.alert('请填写忘打卡时间');
			return;
		}
		var url = "${pageContext.request.contextPath }/flow/ApplySupplement/saveSupplement";
		$.post(url, {
			flowmodeltypeid : $("#window_flowHoliday #flowModelTypeid").val(),
			sutime : $("#window_flowHoliday #stratTime").val(),
			suremark : $("#window_flowHoliday #remark").val()
		}, addSrmHoliday, "text");
	}
	...
	function addHoliday() {
		...
		var url = "${pageContext.request.contextPath }/flow/ApplySupplement/addSupplement";
		$.post(url, {
			flowmodeltypeid : $("#window_flowHoliday #flowModelTypeid").val(),
			sutime : $("#window_flowHoliday #stratTime").val(),
			suremark : $("#window_flowHoliday #remark").val()
		...
		<div class="modal-dialog">
			<div class="modal-content animated bounceInRight">
				<div class="modal-header">
					<h4 class="modal-title">忘打卡申请单</h4>
				</div>
				<div class="ibox-content">
					<form class="form-horizontal m-t" id="flowHolidayStudFrom"
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select id="flowModelTypeid" disabled="disabled" class="form-control">
