...
<script type="text/javascript">
	...
	function addStudent(id) {
		...
		var url = "${pageContext.request.contextPath }/flow/ApplyMaterial/add";
		$.post(url, {
			materialid : $("#window_add #mid").val(),
			counts : $("#window_add #counts").val(),
			applymaterialRemark : $("#window_add #remark").val(),
	...
	function selecttype() {
		var url = "${pageContext.request.contextPath }/flow/ApplyChangeDuty/findmaterial";
		$.post(url, {
	...
	function selectmaterial() {
		var url = "${pageContext.request.contextPath }/flow/ApplyMaterial/findless";
		$.post(url, {
	...
	function mess(data) {
		...
		if (len > 0) {
			for (i = 0; i < datas.rows.length; i++) {
				...
				value= datas.rows[i].lessnumber;
				$("#window_add #counts").val(value);
				$("#window_add #mid").val(datas.rows[i].materialid);
			}
		}
			...
			<div class="modal-content animated bounceInRight">
				...
				<div class="ibox-content">
					<form class="form-horizontal m-t" id="commentForm"
						...
						<div class="form-group">
							<label class="col-sm-4 control-label">距离正常供应还需：</label>
							<div class="col-sm-4">
