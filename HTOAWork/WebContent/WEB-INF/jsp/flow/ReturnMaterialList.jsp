...
<script type="text/javascript">
	...
	function addStudent(id) {
		...
		//return;
		var url = "${pageContext.request.contextPath }/flow/ReturnMaterial/add";
		$.post(url, {
	...
	function selecttype() {
		var url = "${pageContext.request.contextPath }/flow/ReturnMaterial/findmaterial";
		$.post(url, {
		...
		<div class="modal-dialog">
			<div class="modal-content animated bounceInRight">
				<div class="modal-header">
					<h4 class="modal-title">物品归还</h4>
				</div>
				<div class="ibox-content">
					<form class="form-horizontal m-t" id="commentForm"
						novalidate="novalidate">
						<div class="form-group">
							<label class="col-sm-4 control-label">归还类型：</label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label class="col-sm-4 control-label">归还数量：</label>
							<div class="col-sm-4">
