...
<script type="text/javascript">
	...
	$(function() {
		...
		$('#btn_query').click(function () {
			...
			$('#tb_FlowAllEmp').bootstrapTable('refresh');
		});
		
		//表格数据
		$('#tb_FlowAllEmp').bootstrapTable({
			url : '${pageContext.request.contextPath}/flow/flowAll/findFlowAllEmp', //请求后台的URL（*）
			method : 'post', //请求方式（*）
	...
	function selectEmp(){
		var url = "${pageContext.request.contextPath }/flow/flowAll/findEmpList";
		$.post(url, {
			id : $("#depid").val(),
		}, inemp, "json");
	}
						...
						<form id="formSearch" class="form-horizontal">
							<div class="form-group">
								<div class="row">
			                        ...
			                        <div class="col-sm-2">
										<select class="form-control" id="depid" onchange="selectEmp();">
											<option value="">--------</option>
									...
									<label class="control-label col-sm-1">员工姓名:</label>
			                        <div class="col-sm-2">
			               	...
			               	<div class="form-group">
			                   	<div class="row">
			                        ...
			                        <div class="col-sm-1">
										<a href="${pageContext.request.contextPath }/flow/flowAll/flowAllEmp">
