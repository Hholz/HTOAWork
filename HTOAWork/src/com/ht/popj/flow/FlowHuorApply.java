...
public class FlowHuorApply {
	...
	public String toString() {
		return "FlowHuorApply [id=" + id + ", flowmodeltypeid=" + flowmodeltypeid + ", studid=" + studid + ", huorid="
				+ huorid + ", createTime=" + createTime + ", updateTime=" + updateTime + ", status=" + status
				+ ", remark=" + remark + ", upset=" + upset + "]";
	}
