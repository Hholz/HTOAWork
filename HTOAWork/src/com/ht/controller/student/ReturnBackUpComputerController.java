...
@Controller
@RequestMapping("/student/ReturnBackUpComputer")
public class ReturnBackUpComputerController {
	...
	@SystemControllerLog(description = "进入备用电脑归还审批页面")
	public String List(Model model) {
		...
		// 后勤部确认页面
		return "/student/ReturnBackUpComputerTaskList";
	}
	...
	public String updata(Model model, StudentComputerApply returnmaterial) {
		...
		return "redirect:/student/ReturnBackUpComputer/tasklist";
	}
